...
int PatternCalls(){
								int choice;
								DataBase call;
								string FileName = "../src/patterns/dataFile.csv";
								int dataSize = 100000;
								int idx;
								string name, col;
								...
								DataProcessing csvObj("../src/patterns/dataFile.csv");
								typedef vector<vector<string> > CsvVector;
								vector<string> headers = csvObj.GetHeader();
								while(1) {
																choice = mainMenu();
																if(choice == END)
																								break;
																...
																case GET: {
																								...
																								call.GenerateDatabase(FileName, dataSize);
																								break;
																}
																case RETRIEVE: {
																								...
																								vector<string> rowId = csvObj.GetRow(idx); // Get rows by index
																								cout<<"\n"<<"*******************************************************"<<"\n";
																								break;
																}
																...
																case LIST: {  cout << "\n Recommended Columns: [id, name,patternFile,called]" << endl;
																														...
																														if (it != columns.end()) {
																																						...
																																						cin >> name;
																																						vector<string>  colData = csvObj.ColumnInfo(col);
